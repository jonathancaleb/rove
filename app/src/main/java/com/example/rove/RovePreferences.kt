...
class RovePreferences(context: Context) {
    ...
    companion object {
        ...
        fun initPrefs(context: Context): RovePreferences {
            // if the INSTANCE is not null, then return it,
            // if it is, then create the preferences
            return INSTANCE ?: synchronized(this) {
                val instance = RovePreferences(context)
                INSTANCE = instance
                // return instance
                instance
            }
        ...
        fun getPrefsInstance(): RovePreferences {
